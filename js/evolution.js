...
function bindEvolutionForm_() {
    ...
    els.form.addEventListener("submit", function(e) {
        ...
        if (!payload.motivo_consulta || !payload.evolucion || !payload.diagnostico || !payload.tratamiento) {
            alert("Completa motivo de consulta, evolución, diagnóstico y tratamiento.");
            return;
        }
